...
export default function Home() {
    ...
    const [cards, setCards] = useState([
        ...
        },
        {
            id: 2,
            title: 'Productos',
            description: 'Diferentes paquetes de Productos cada uno con su precio para poder elegirlos en las recetas y sacar un costo mas fiable de cada una.',
            url: '/Paquetes',
            cant: 0,
        },
        {
            id: 3,
            title: 'Recetas',
            description: 'Tus recetas privadas en las cuales podes cargar los ingredientes, instruciones, cuantas porcines rindes, y el consto con los precios de los productos cargados.',
            url: '/Recetas',
            cant: 0,
        },
    ]);
